...
if __name__ == '__main__':
    def args_parser():
        ...
        parser.add_argument('--align_datadir', type=str, default='/home/chase/shy/DGDA/data/NEU-CLS/DGDAT700', help='datadir of align dataset')
        parser.add_argument('--train_datadir', type=str, default='/home/chase/shy/DGDA/data/NEU-CLS/train', help='datadir of train dataset')
        parser.add_argument('--test_datadir', type=str, default='/home/chase/shy/DGDA/data/NEU-CLS/test', help='datadir of test dataset')
