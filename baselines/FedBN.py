...
if __name__ == '__main__':
    def args_parser():
        ...
        parser.add_argument('--align_datadir', type=str, default='/home/chase/shy/DGDA/data/MT/DGDA', help='datadir of align dataset')
        parser.add_argument('--train_datadir', type=str, default='/home/chase/shy/DGDA/data/MT/train', help='datadir of train dataset')
        parser.add_argument('--test_datadir', type=str, default='/home/chase/shy/DGDA/data/MT/test', help='datadir of test dataset')
