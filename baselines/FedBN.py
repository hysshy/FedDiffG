...
from util import gen_classes_per_node, gen_data_split
import copy
import argparse
...
if __name__ == '__main__':
    def args_parser():
        ...
        parser.add_argument('--align_datadir', type=str, default='/home/chase/shy/FedDGDA/data/MT/FedDGDA', help='datadir of align dataset')
        parser.add_argument('--train_datadir', type=str, default='/home/chase/shy/FedDGDA/data/MT/train', help='datadir of train dataset')
        parser.add_argument('--test_datadir', type=str, default='/home/chase/shy/FedDGDA/data/MT/test', help='datadir of test dataset')
        parser.add_argument('--align_batch_size', type=int, default=64, help='align batch_size')
        parser.add_argument('--local_batch_size', type=int, default=64, help='local clients batch_size')
